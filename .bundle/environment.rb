...
module Bundler
  ENV_LOADED   = true
  LOCKED_BY    = '0.9.26'
  FINGERPRINT  = "d4db589930d5b97fe9d747c5877fd8af5ffca8c8"
  HOME         = '/home/julien/.bundle/ruby/1.8/bundler'
  AUTOREQUIRES = {:default=>[["authlogic", false], ["encryptor", false], ["rails", false]]}
  SPECS        = [
        ...
        {:load_paths=>["/usr/lib/ruby/gems/1.8/gems/authlogic-2.1.5/lib"], :loaded_from=>"/usr/lib/ruby/gems/1.8/specifications/authlogic-2.1.5.gemspec", :name=>"authlogic"},
        {:load_paths=>["/usr/lib/ruby/gems/1.8/gems/encryptor-1.1.1/lib"], :loaded_from=>"/usr/lib/ruby/gems/1.8/specifications/encryptor-1.1.1.gemspec", :name=>"encryptor"},
